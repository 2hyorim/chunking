...
expName = 'test360'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ailee\\OneDrive\\바탕 화면\\24-2\\실험심\\팀플\\프로그래밍 시도\\test\\test360_lastrun.py',
